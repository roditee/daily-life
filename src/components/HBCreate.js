...
const HBCreate = () => {
  ...
  <div className='cardTitle'>
      ...
      <div class="card">
            ...
            <h4>저금통의 이름은 무엇인가요?</h4>
              <input type='text' name='hbName' className='hbName' value={HB.hbName} onChange={onChange} placeholder='ex. 민초단의 추억' required/>
            ...
            <table>
              <tr>
                ...
                <td>
                  <input type='date' name='hbEndDate' className='hbEndDate' value={HB.hbEndDate} onChange={onChange}  required/>
                </td>
              </tr>
            </table>

              <h5>* 한 번 설정한 날짜는 변경할 수 없습니다. <br/>
            ...
            <input className='button2' type='reset' value="취소" />
